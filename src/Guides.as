namespace TmMcp {
    ...
    void _InitGuides() {
        ...
        _RegisterGuide("menu-navigation",
            ...
            + "  events, not yet figured out. FocusMenuControl can focus a control by id but"
            + "  does NOT click. The underlying click handler lives in Trackmania.Title.Pack.Gbx.\n"
